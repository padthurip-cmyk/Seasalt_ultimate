/**
 * SeaSalt Pickles - Cart & Checkout Module v7
 * ============================================
 * Uses UI.lockScroll/unlockScroll for consistent scroll handling
 */
...
const Cart = (function() {
    ...
    function init() {
        ...
        subscribeToChanges();
        initWalletCheckbox();
        console.log('[Cart] v7 Initialized');
    }
    ...
    function handleCheckout() {
        ...
        // Hide cart without unlocking scroll (checkout will take over)
        var cartSidebar = document.getElementById('cart-sidebar');
        if (cartSidebar) {
            cartSidebar.classList.add('hidden');
        }
        
        // Show checkout (scroll already locked from cart)
        showCheckoutForm();
    }
