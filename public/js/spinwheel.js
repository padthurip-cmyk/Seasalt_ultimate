    ...
    (function() {
        ...
        function handleSendOtp() {
            ...
            checkCanSpin(userPhone).then(function(res) {
                ...
                if (isTestNumber(userPhone)) {
                    ...
                    var saved = {}; try { var _p = JSON.parse(localStorage.getItem('seasalt_user') || '{}'); if (_p && typeof _p === 'object') saved = _p; } catch(e) {}
        ...
        function handleVerify() {
            ...
            confirmationResult.confirm(otp).then(function(result) {
                ...
                var u = result.user;
                var saved = {}; try { var _p2 = JSON.parse(localStorage.getItem('seasalt_user') || '{}'); if (_p2 && typeof _p2 === 'object') saved = _p2; } catch(e) {}
